 ...
 * {@link #getInBackground(Object)} method, using a {@link GetCallback}. For example, this
 ...
 *  {@link #count()} calls, which do block the calling thread. For example,
 ...
 * </p>
 */
public class  EquilibreQuery<T1 extends EquilibreObject, T2> {

    Dao<? extends EquilibreObject, T2> dao;
     ...
     */
    public QueryBuilder<T1, T2> getQueryBuilder(){
    ...
    public EquilibreQuery(Class<T1> subclass) {
     ...
     * @param <T1> the type of model your currently manipulated
     */
    public static <T1 extends EquilibreObject, T2>  EquilibreQuery<T1, T2> getQuery(Class<T1> subclass) {
        return new EquilibreQuery<T1,T2>(subclass);
    }
    ...
    public void refresh(final T1 t) throws EquilibreException {
     ...
     */
    public void refreshInBackground(final T1 t, RefreshCallback callback){
     ...
     * @return
     */
    private Task<T1> refreshInBackground(final T1 t){
        return taskQueue.enqueue(new Continuation<Void, Task<T1>>() {
            @Override
            public Task<T1> then(Task<Void> task) throws Exception {
                return task.continueWith(new Continuation<Void, T1>() {
                    @Override
                    public T1 then(Task<Void> task) throws Exception {
                        int result = getDao().update(t);
                        if (result > 0) {
                            Log.d(Equilibre.TAG, t.getClass().getSimpleName() + " updated successfully with Id ==>>> " + t.getEquilibreId());
                        } else {
    ...
    public void delete(T1 t) throws EquilibreException {
     ...
     *          See {@link DeleteCallback}
     */
    public void deleteInBackground(T2 id, DeleteCallback callback){
     ...
     *          See {@link DeleteCallback}
     */
    public void deleteInBackground(final T1 t, DeleteCallback callback){
     ...
     *        the object to save
     */
    private Task<Void> deleteInBackground(final T1 t){
        checkIfRunning(true);
        return taskQueue.enqueue(new Continuation<Void, Task<Void>>() {
            ...
            public Void then(Task<Void> task) throws Exception {
                ...
                if (result>0){
                    Log.d(Equilibre.TAG, t.getClass().getSimpleName()+" deleted successfully with Id ==>>> "+t.getEquilibreId());
                }else{
     ...
     */
    private Task<Void> deleteInBackground(final T2 id){
        checkIfRunning(true);
        return taskQueue.enqueue(new Continuation<Void, Task<Void>>() {
            @Override
            public Task<Void> then(Task<Void> task) throws Exception {
     ...
     * @return A {@link Task} that is resolved when finding completes.
     */
    private Task<List<T1>> findInBackground(){
        checkIfRunning(true);
        return Task.callInBackground(new Callable<List<T1>>() {
            @Override
    ...
    private Task<T1> findOneInBackground(){
        checkIfRunning(true);
        return Task.callInBackground(new Callable<T1>() {
            @Override
     ...
     */
    public T1 get(T2 id) throws EquilibreException {
     ...
     * @throws EquilibreException an exception can be thrown if something is wrong
     */
    public List<T1> find() throws EquilibreException {
     ...
     */
    public void getInBackground(final T2 id, GetCallback callback){
     ...
     * @param id
     *        the object to save
     * @return A {@link Task} that is resolved when getting all completes.
     */
    private Task<T1> getInBackground(final T2 id){
        checkIfRunning(true);
        return Task.callInBackground(new Callable<T1>() {
            @Override
            public T1 call() throws Exception {
                T1 t = (T1) getDao().queryForId(id);
     ...
     */
    public void save(T1 t) throws EquilibreException {
     ...
     *          the callback to get the feedback after saving
     */
    public void saveInBackground(T1 t, SaveCallback callback){
     ...
     * @param t
     *      the object to save
     * @return A {@link Task} that is resolved when saving all completes.
     */
    private  Task<Void> saveInBackground(final T1 t ){
        return taskQueue.enqueue(new Continuation<Void, Task<Void>>() {
            @Override
            public Task<Void> then(Task<Void> task) throws Exception {
                return task;
            ...
            public Void then(Task<Void> task) throws Exception {
                ...
                if (result > 0) {
                    Log.d(Equilibre.TAG, t.getClass().getSimpleName() + " saved successfully with Id ==>>> " + t.getEquilibreId());
                } else {
                    Log.e(Equilibre.TAG, " echec when saved" + t.getClass().getSimpleName());
                }
                return null;
     ...
     */
    public EquilibreQuery<T1, T2> whereObjectIdEquals(T2 id) throws SQLException {
     ...
     * @throws SQLException an SQL exception can be thrown if something is wrong
     */
    public EquilibreQuery<T1, T2> whereEqualTo(String key, Object value) throws SQLException {
        synchronized (LOCK){
     ...
     * @throws SQLException an SQL exception can be thrown if something is wrong
     */
    public EquilibreQuery<T1, T2> whereNotEqualTo(String key, Object value) throws SQLException {
        checkIfRunning();
        synchronized (LOCK){
     ...
     * @return this, so you can chain this call.
     */
    public EquilibreQuery<T1, T2>  orderByAscending(String key){
        checkIfRunning();
        synchronized (LOCK) {
     ...
     * @return this, so you can chain this call.
     */
    public EquilibreQuery<T1, T2>  orderByDescending(String key) {
        checkIfRunning();
     ...
     * @return this, so you can chain this call.
     */
    public EquilibreQuery<T1, T2>  setLimit(Long newLimit){
        checkIfRunning();
     ...
     * @throws SQLException an SQL exception can be thrown if something is wrong
     */
    public EquilibreQuery<T1, T2>  whereLessThan(String key, Object value) throws SQLException {
        checkIfRunning();
        synchronized (LOCK) {
     ...
     * @throws SQLException an SQL exception can be thrown if something is wrong
     */
    public EquilibreQuery<T1, T2>  whereGreaterThan(String key, Object value) throws SQLException {
        checkIfRunning();
        synchronized (LOCK) {
     ...
     * @throws SQLException an SQL exception can be thrown if something is wrong
     */
    public EquilibreQuery<T1, T2> whereLessThanOrEqualTo(String key, Object value) throws SQLException {
        checkIfRunning();
        synchronized (LOCK){
     ...
     * @throws SQLException an SQL exception can be thrown if something is wrong
     */
    public EquilibreQuery<T1, T2>  whereGreaterThanOrEqualTo(String key, Object value) throws SQLException {
        checkIfRunning();
        synchronized (LOCK){
     ...
     * @throws SQLException an SQL exception can be thrown if something is wrong
     */
    public EquilibreQuery<T1, T2>  whereContainedIn(String key, Iterable<?> values) throws SQLException {
        checkIfRunning();
        synchronized (LOCK){
     ...
     * @throws SQLException an SQL exception can be thrown if something is wrong
     */
    public EquilibreQuery<T1, T2>  whereContainedIn(String key,Object... values ) throws SQLException {
        checkIfRunning();
        synchronized (LOCK){
            wheres = wheres.in(key, values);
            this.queryBuilder.setWhere(wheres);
     ...
     * @throws SQLException an SQL exception can be thrown if something is wrong
     */
    public EquilibreQuery<T1, T2>  whereContainedIn(String key,QueryBuilder values ) throws SQLException {
        checkIfRunning();
        synchronized (LOCK){
            wheres = wheres.in(key, values);
            this.queryBuilder.setWhere(wheres);
     ...
     * @throws SQLException an SQL exception can be thrown if something is wrong
     */
    public EquilibreQuery<T1, T2>  whereExists(QueryBuilder queryBuilder) throws SQLException {
        checkIfRunning();
     ...
     * @throws SQLException an SQL exception can be thrown if something is wrong
     */
    public EquilibreQuery<T1, T2>  groupBy(String key) throws SQLException {
        synchronized (LOCK){
     ...
     * @throws SQLException an SQL exception can be thrown if something is wrong
     */
    public EquilibreQuery<T1, T2>  whereBetween(String key, Object low, Object high)throws SQLException {
        checkIfRunning();
        synchronized (LOCK){
     ...
     * @throws SQLException an SQL exception can be thrown if something is wrong
     */
    public EquilibreQuery<T1, T2>  whereLike(String key, Object value)throws SQLException {
        checkIfRunning();
        synchronized (LOCK){
     ...
     * @throws SQLException an SQL exception can be thrown if something is wrong
     */
    public EquilibreQuery<T1, T2>  whereIsNotNull(String key)throws SQLException {
        checkIfRunning();
        synchronized (LOCK){
     ...
     * @throws SQLException an SQL exception can be thrown if something is wrong
     */
    public EquilibreQuery<T1, T2>  or()throws SQLException {
        checkIfRunning();
        synchronized (LOCK){
            wheres = wheres.or();
            this.queryBuilder.setWhere(wheres);
     ...
     * @throws SQLException an SQL exception can be thrown if something is wrong
     */
    public EquilibreQuery<T1, T2>  and()throws SQLException {
        checkIfRunning();
        synchronized (LOCK){
            wheres = wheres.and();
            this.queryBuilder.setWhere(wheres);
     ...
     * @throws SQLException an SQL exception can be thrown if something is wrong
     */
    public EquilibreQuery<T1, T2>  withJoin(QueryBuilder builder)throws SQLException {
        checkIfRunning();
        synchronized (LOCK){
     ...
     * @throws SQLException an SQL exception can be thrown if something is wrong
     */
    public EquilibreQuery<T1, T2>  withJoinOr(QueryBuilder builder)throws SQLException {
        checkIfRunning();
        synchronized (LOCK){
     ...
     * @throws SQLException an SQL exception can be thrown if something is wrong
     */
    public EquilibreQuery<T1, T2>  distinct()throws SQLException {
        checkIfRunning();
        synchronized (LOCK){
     ...
     * @throws SQLException an SQL exception can be thrown if something is wrong
     */
    public EquilibreQuery<T1, T2>  withLeftJoin(QueryBuilder builder)throws SQLException {
        checkIfRunning();
        synchronized (LOCK){
     ...
     * @throws SQLException an SQL exception can be thrown if something is wrong
     */
    public EquilibreQuery<T1, T2>  withLeftJoinOr(QueryBuilder builder)throws SQLException {
        checkIfRunning();
        synchronized (LOCK){
    ...
    public EquilibreQuery<T1, T2>  having(String having)throws SQLException {
        checkIfRunning();
        synchronized (LOCK){
     ...
     * @throws SQLException an SQL exception can be thrown if something is wrong
     */
    public EquilibreQuery<T1, T2>  groupByRaw(String rawSql)throws SQLException {
        checkIfRunning();
        synchronized (LOCK){
     ...
     * @throws SQLException an SQL exception can be thrown if something is wrong
     */
    public EquilibreQuery<T1, T2>  setOffSet(Long startRow)throws SQLException {
        checkIfRunning();
        synchronized (LOCK){
