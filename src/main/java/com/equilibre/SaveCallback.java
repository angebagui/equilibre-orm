...
/**
 * A {@code SaveCallback} is used to run code after saving a {@link EquilibreObject} in a background
 * thread.
 * <p>
 ...
 * </pre>
 */
public interface SaveCallback extends EquilibreCallback1<EquilibreException> {
  /**
